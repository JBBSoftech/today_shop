...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/today_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a30ecf78bc32f6197424b3a',
...
app.listen(PORT, () => {
  ...
  console.log(`Today shop Backend Server running on port ${PORT}`);
